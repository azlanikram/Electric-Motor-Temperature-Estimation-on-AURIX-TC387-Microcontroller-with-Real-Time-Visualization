...
#ifndef TFT_CONIO_TFT_H_
#define TFT_CONIO_TFT_H_
...
{
    uint8 color_display;        //upper most 4 bits are background color, lower 4 bits text color
...
IFX_EXTERN void conio_periodic ();  //this function is called out of the timer tick
